const express = require('express');
  ...
  // MongoDB connection
  mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/arav_shop_app', {
  ...
  app.get('/api/app-config', async (req, res) => {
    try {
      ...
      const config = {
        adminId: '694667a8cc43a00315d0a542',
        shopName: 'Arav shop',
  ...
  app.listen(PORT, () => {
    console.log(`Arav shop Backend Server running on port ${PORT}`);
  });
